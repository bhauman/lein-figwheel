...
#_(.lastModified (io/file "project.clj"))
...
#_(file-change-wait "project.clj" 100000)
              ...
              (do
                ...
                (let [choice (or (and fix "f")
                                 (do
                                   ...
                                   (print "Please choose q, f or s and then hit enter: ")
                                   (flush)
                                   (get-choice ["s" "f" "q"])))]
                  (condp = choice
                    "q" false
...
#_(validate-loop
   (fn [] (read-string (slurp "figwheel_edn")))
   {:file "figwheel_edn"})
