...
;; TODO change this so that clients of this library can register
;; to catch this event
(defmethod heads-up-event-dispatch "file-selected" [dataset]
  #_(socket/send! {:figwheel-event "file-selected"
...
#_(defn auto-notify-source-file-line [{:keys [file line column]}]
  #_(socket/send! {:figwheel-event "file-selected"
                   :file-name (str file)
                   :file-line (str line)
